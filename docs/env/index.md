...
本节记录了在 macOS（Apple M1/M2 芯片，Sequoia 15.5 及以上）下配置 rCore
...
请确保使用 macOS Sequoia 15.5 及以上版本系统（推荐使用最新稳定版本）。
...
至此，我们已经完成了 rCore 实验环境的主要配置步骤。如果在实际使用过程中遇到其他问题，欢迎参考本页内容或查阅相关文档，也欢迎交流补充。
