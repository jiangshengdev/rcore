...
import Riscv64UnknownElfGdb from './_assets/ansi/riscv64-unknown-elf-gdb.mdx';
import LogDebugMakeRun from './_assets/ansi/log-debug-make-run.mdx';
...
其他芯片型号或系统版本尚未经过测试，配置过程中可能会遇到未预料的问题，建议优先使用推荐的硬件与系统环境。
...
至此，我们已经完成了 rCore 实验环境的主要配置步骤。如果在实际使用过程中遇到问题，可以重新查阅本页相关章节进行排查。如果遇到本页未涵盖的问题，建议查阅相关官方文档或向社区求助。
