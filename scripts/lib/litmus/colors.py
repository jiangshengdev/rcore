...
LITMUS_THEME_COLORS: Dict[str, Dict[str, Any]] = {
    "light": {
        ...
        "edge_ppo": SYSTEM_PURPLE_LIGHT,  # 使用紫色对应原始 indigo
        "edge_fence": SYSTEM_PURPLE_LIGHT,  # fence 指令
        "edge_addr": SYSTEM_CYAN_LIGHT,  # address 依赖
        "edge_ctrl": SYSTEM_YELLOW_LIGHT,  # control 依赖
    ...
    "dark": {
        ...
        "edge_ppo": SYSTEM_PURPLE_DARK,  # 使用紫色对应原始 indigo
        "edge_fence": SYSTEM_PURPLE_DARK,  # fence 指令
        "edge_addr": SYSTEM_CYAN_DARK,  # address 依赖
        "edge_ctrl": SYSTEM_YELLOW_DARK,  # control 依赖
